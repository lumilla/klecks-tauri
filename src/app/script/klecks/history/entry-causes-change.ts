...
export function entryCausesChange(
  ...
  if (entry.layerMap !== undefined) {
    ...
    for (const layerId of entryLayerMapIds) {
      ...
      if (
        entryLayer.name !== undefined &&
        entryLayer.name !== composedLayer.name
      ) {
        return true;
      }
      if (
        entryLayer.opacity !== undefined &&
        entryLayer.opacity !== composedLayer.opacity
      ) {
        return true;
      }
      if (
      ...
      if (
        entryLayer.index !== undefined &&
        entryLayer.index !== composedLayer.index
      ) {
        return true;
      }
