...
export const filterCropExtend = {
  getDialog(params: TFilterGetDialogParam) {
    ...
    const tempCanvas = BB.canvas();
    {
      ...
      BB.ctx(tempCanvas).drawImage(
        klCanvas.getCompleteCanvas(previewFactor),
        0,
        0,
        w,
        h,
    ...
    function update(transform: TRect): void {
      ...
      right = parseInt(
        "" + (transform.x + transform.width - klCanvas.getWidth()),
      );
      bottom = parseInt(
        "" + (transform.y + transform.height - klCanvas.getHeight()),
      );
      leftInput.value = "" + left;
      topInput.value = "" + top;
      rightInput.value = "" + right;
      ...
      previewWrapper.style.backgroundPosition =
