...
export class EaselRotate implements TEaselTool {
  ...
  onUpdateTransform(transform: TViewportTransform): void {
    ...
    this.needleWrapper.setAttribute(
      "transform",
      "rotate(" + transform.angleDeg + ")",
    );
    this.compassLineCircle.style.opacity =
      targetTransform.angleDeg % 90 === 0 ? "1" : "0";
  }
