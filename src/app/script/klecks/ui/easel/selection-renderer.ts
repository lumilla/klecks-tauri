...
import classes from "./selection-renderer.module.scss";
...
export class SelectionRenderer {
  ...
  private update(): void {
    const selection =
      this.renderedSelection === null ? this.selection : this.renderedSelection;
    ...
    const clippedSelection = applyPolygonClipping(
      "intersection",
  ...
  setRenderedSelection(
    renderedSelection?: MultiPolygon,
    isImmediate?: boolean,
  ): void {
