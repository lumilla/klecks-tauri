...
export class KlColorSlider {
  ...
  private updateSVCanvas(): void {
    const rgb = BB.ColorConverter.toRGB(
      new BB.HSV(this.primaryColorHsv.h, 100, 100),
    );
  ...
  constructor(p: {
    ...
    this.secondaryColorHsv = BB.ColorConverter._RGBtoHSV(
      this.secondaryColorRgb,
    ); // BB.HSV
    ...
    css(this.controlH, {
      ...
      top: "0",
      left:
        parseInt("" + ((this.primaryColorHsv.h / 360) * this.width - 1)) + "px",
    });
    ...
    this.pickerButton = BB.el({
      ...
      onClick: () => {
        if (this.isPicking) {
          ...
          this.pickerButton.classList.remove(
    ...
    const pickerButtonPointerListener = new BB.PointerListener({
      ...
      onEnterLeave: (isOver) => {
        ...
        this.pickerButton.classList.toggle(
          "color-picker-preview-button-hover",
          isOver,
        );
      },
    ...
    const hexButtonPointerListener = new BB.PointerListener({
      ...
      onEnterLeave: (isOver) => {
        this.hexButton.classList.toggle(
          "color-picker-preview-button-hover",
          isOver,
        );
      },
        ...
        onPointer: (event) => {
          if (event.type === "pointerdown") {
            ...
            if (event.button === "left") {
              ...
              this.primaryColorRgb = BB.ColorConverter.toRGB(
                this.primaryColorHsv,
              );
      ...
      const hPointerListener = new BB.PointerListener({
        ...
        onPointer: (event) => {
          ...
          if (
            ...
            const factor = calcSliderFalloffFactor(
              deltaY,
              event.button === "right",
            );
