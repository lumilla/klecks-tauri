...
import classes from "./color-slider-hex-dialog.module.scss";
  ...
  constructor(p: { color: TRgb; onClose: (rgb: TRgb | undefined) => void }) {
    ...
    const hexInput = input({
      ...
      callback: function () {
        ...
        previewEl.style.background =
          "#" + BB.ColorConverter.toHexString(rgbObj);
    ...
    function createRgbInputRow(
      ...
      const inputEl = input({
        ...
        callback: function () {
          ...
          previewEl.style.background =
            "#" + BB.ColorConverter.toHexString(lastValidRgb);
          hexInput.value = "#" + BB.ColorConverter.toHexString(lastValidRgb);
        },
      });
    ...
    showModal({
      ...
      callback: function (resultStr) {
        ...
        p.onClose(
          resultStr === "Ok"
            ? BB.ColorConverter.hexToRGB(hexInput.value)
            : undefined,
        );
      },
    });
