        ...
        button.onclick = () => {
          ...
          const finishedDialog = (
            ...
            try {
              ...
              if (
                (e as Error).message.indexOf(".getInput is not a function") !==
                -1
              ) {
                throw (
                  "filterDialog.getInput is not a function, filter: " +
                  filterName
                );
              } else {
                throw e;
          ...
          if (filters[filterKey].isInstant) {
            ...
            let filterDialog: TFilterGetDialogResult<any> | undefined =
              undefined;
