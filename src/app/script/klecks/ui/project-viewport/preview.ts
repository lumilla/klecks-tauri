...
export class Preview {
  ...
  private readonly onTransformChange:
    | TPreviewParams["onTransformChange"]
    | undefined;
  ...
  private renderLoop = (): void => {
    ...
    if (this.doRender) {
      ...
      if (
        ...
        JSON.stringify(this.lastEmittedTransform) !==
    ...
    this.rootEl = c(
      ...
      [
        ...
        ...(this.modeToggle
          ...
          : []),
        c(
          ",pos-absolute,right-5,bottom-5,flex,flexCol,gap-5,z-1,pointer-auto",
          [
            c({
              tagName: "button",
